...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, LocalDate.of(2022, 11, 20), "Partiu viagem", "Vou viajar para MG, abraços!",vinicius);
        Post post2 = new Post(null, LocalDate.now(),"Chegando ao destino", "Lugar maravilhoso, obrigado Deus!", davi);
